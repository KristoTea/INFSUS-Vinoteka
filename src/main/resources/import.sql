...
INSERT INTO wine (id, name, harvest, alcohol_percentage, maltster, quality, vineyard, temperature_of_serving, gastro_recommendation, description, price, sort_id)VALUES (100, 'Chardonnay', 2021, 13.5, 'Dry', 'High', 'Vineyard XYZ', 10.0, 'Perfect with seafood', 'Chardonnay is a versatile white wine...', 29.99, 1);
INSERT INTO wine (id, name, harvest, alcohol_percentage, maltster, quality, vineyard, temperature_of_serving, gastro_recommendation, description, price, sort_id)VALUES (102, 'Merlot', 2020, 14.2, 'Semi Dry', 'Medium', 'Vineyard ABC', 16.0, 'Pairs well with red meat', 'Merlot is a red wine known for its...', 39.99, 2);
INSERT INTO wine (id, name, harvest, alcohol_percentage, maltster, quality, vineyard, temperature_of_serving, gastro_recommendation, description, price, sort_id)VALUES (103, 'Pinot Noir', 2019, 12.8, 'Semi Sweet', 'High', 'Vineyard LMN', 14.0, 'Great with grilled salmon', 'Pinot Noir is a delicate red wine...', 34.99, 3);
INSERT INTO wine (id, name, harvest, alcohol_percentage, maltster, quality, vineyard, temperature_of_serving, gastro_recommendation, description, price, sort_id)VALUES (104, 'Sauvignon Blanc', 2022, 11.5, 'Dry', 'Medium', 'Vineyard PQR', 8.0, 'Refreshing with salads', 'Sauvignon Blanc is a crisp white wine...', 24.99, 1);
INSERT INTO wine (id, name, harvest, alcohol_percentage, maltster, quality, vineyard, temperature_of_serving, gastro_recommendation, description, price, sort_id)VALUES (105, 'Syrah', 2018, 14.8, 'Dry', 'High', 'Vineyard DEF', 18.0, 'Pairs well with spicy dishes', 'Syrah (or Shiraz) is a bold red wine...', 42.99, 2);
...
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (1, 102);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (1, 103);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (1, 104);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (2, 100);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (2, 102);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (2, 102);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (2, 104);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (3, 103);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (4, 103);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (4, 103);
INSERT INTO wineorder_wine (order_id, wine_id) VALUES (5, 105);